...
const Footer = () => {
  return (
    <footer className="w-full bg-deep-indigo text-primary padding md:px-36">
      ...
      <div className="flex max-md:flex-col-reverse max-md:gap-8 items-center justify-between w-[100%]">
        <div className="capitalize text-xs text-slate-400 font-[200]">
          2024 WHITE CODE. ALL RIGHTS RESERVED.
        </div>
